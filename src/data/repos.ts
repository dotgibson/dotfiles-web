...
export const repos: Repo[] = [
  {
    ...
    specifics: [
      ...
      },
      {
        ...
        detail:
          'Core is vendored into every OS repo via git subtree — except Windows, which replicates it natively — so a defect fixed once lands everywhere on the next make sync. Treat every change as if it ships to all of them — because it does.',
      },
    ],
    docs: [
