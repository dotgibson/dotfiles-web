...
natively in PowerShell — so a defect in Core fans out to every machine at once. That leverage is the whole point — and the reason Core changes go through a
